...
function makeStyles(C: AppTheme) {
  return StyleSheet.create({
    ...
    slot: { flex: 1 },
    bar: { backgroundColor: C.card, borderTopWidth: 1, borderTopColor: C.line, alignItems: 'center' },
    barInner: { flexDirection: 'row', maxWidth: 480, width: '100%', paddingVertical: 6, paddingBottom: 12 },
    tabBtn: { flex: 1, alignItems: 'center', gap: 2, paddingVertical: 4, cursor: 'pointer' as any },
